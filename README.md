...
Full-stack application deployed to AWS through a containerized architecture.

Designed and automated the path from local development to a live cloud deployment using Docker Compose, Nginx, GitHub Actions, Docker Hub, Terraform, AWS networking, EC2 and CloudWatch.

"React" "Node.js" "PostgreSQL" "Docker" "AWS" "Terraform"
